...
Use Lock:
Quando não há necessidade de reentrância.
Quando o lock será adquirido e liberado apenas uma vez por thread em cada ciclo.

Use RLock:
Quando uma thread precisa adquirir o lock várias vezes (reentrância).
Exemplo: ao implementar métodos em uma classe que usa o mesmo lock em diferentes níveis de chamada.
'''
